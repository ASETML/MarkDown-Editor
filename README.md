...
| Raccourci | Utilité | Version longue |
| --- | --- | --- |
| `{{date}}` | La date actuelle | `<span class="date"></span>` |
| `{{pageNumber}}` | Le numéro de page | `<span class="pageNumber"></span>` |
| `{{totalPages}}` | Le nombre total de page | `<span class="totalPages"></span>` |
